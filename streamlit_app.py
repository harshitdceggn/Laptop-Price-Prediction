...
repo_id = "harshitdceggn/laptop-price-predictor"  

@st.cache_data
def load_files():
    model_path = hf_hub_download(repo_id=repo_id, filename="pipe.pkl", token=os.getenv("HF_TOKEN"))
    df_path = hf_hub_download(repo_id=repo_id, filename="df.pkl", token=os.getenv("HF_TOKEN"))
